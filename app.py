...
if data is not None:
    ...
    tab1, tab2, tab3, tab4 = st.tabs(["📊 Overview", "📈 Charts", "🧠 AI Insights", "🤖 Chat"])
        ...
        if st.button("Generate Insights"):
            try:
                res = client.chat.completions.create(
                    ...
                    messages=[{
                        "role": "user",
                        "content": f"Analyze this dataset and give key insights:\n{data.head().to_string()}"
                    }]
                )
                st.success(res.choices[0].message.content)
            except:
                st.warning("⚠️ AI service unavailable or quota exceeded")
    ...
    with tab4:
        ...
        if user_input:
            ...
            try:
                ...
                reply = "⚠️ AI not available. Check API/billing."
